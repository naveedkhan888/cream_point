 ...
 */
class CreamPoint_Progress_Bars extends Widget_Base{
	...
	public function get_title() {
		return __( 'XP Progress Bars', 'creampoint' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'bar_style',
			[
				'label' 	=> __( 'Bar Style', 'creampoint' ),
				'type'  	=> Controls_Manager::SELECT,
				'default' 	=> 'line',
				'options' 	=> [
					'line'    => __( 'Style 1: Line', 'creampoint' ),
					'circle'  => __( 'Style 2: Circle', 'creampoint' ),
				]
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Keyword Research', 'creampoint' ),
			]
		);
		$this->add_control(
			'percent',
		...
		$this->add_control(
			'percent_text',
			[
				'label'   => esc_html__( 'Show Percent Text', 'creampoint' ),
		...
		$this->start_controls_section(
			'bar_style_section',
			[
				'label' => __( 'Progress Bar', 'creampoint' ),
		...
		$this->add_responsive_control(
			'bar_size',
			[
				'label' => __( 'Circle Width', 'creampoint' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
		...
		$this->add_responsive_control(
			'line_height_circle',
			[
				'label' => __( 'Line Height', 'creampoint' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
...
// After the CreamPoint_Progress_Bars class is defined, I must register the new widget class with Elementor:
Plugin::instance()->widgets_manager->register( new CreamPoint_Progress_Bars() );