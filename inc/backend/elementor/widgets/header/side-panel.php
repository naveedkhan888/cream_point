 ...
 */
class CreamPoint_Sidepanel extends Widget_Base{
	...
	public function get_title() {
		return __( 'XP Side Panel', 'creampoint' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'style_panel_section',
			[
				'label' => __( 'Side Panel', 'creampoint' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
		...
		$this->add_control(
			'bg_close',
			[
				'label' => __( 'Background Close Button', 'creampoint' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			'color_close',
			[
				'label' => __( 'Color Close Button', 'creampoint' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
...
// After the CreamPoint_Sidepanel class is defined, I must register the new widget class with Elementor:
Plugin::instance()->widgets_manager->register( new CreamPoint_Sidepanel() );