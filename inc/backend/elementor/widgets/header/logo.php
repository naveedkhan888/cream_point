 ...
 * Widget Name: Logo
 */
class CreamPoint_Logo extends Widget_Base{
	...
	protected function register_controls() {
		...
		$this->add_control(
			'logo_image',
			 [
				'label' => esc_html__( 'Image', 'creampoint' ),
...
// After the CreamPoint_Logo class is defined, I must register the new widget class with Elementor:
Plugin::instance()->widgets_manager->register( new CreamPoint_Logo() );