 ...
 */
class CreamPoint_Flip_Box extends Widget_Base{
	...
	public function get_title() {
		return __( 'XP Flip Box', 'creampoint' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Client Learning Programs', 'creampoint' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => 'Description',
				'type' => Controls_Manager::TEXTAREA,
				'default' => __( 'Our firm has helped clients engaged in more than 100 different subsectors of the aerospace, space markets.', 'creampoint' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => 'Label Button',
				'type' => Controls_Manager::TEXTAREA,
				'default' => __( '<i class="xp-webicon-trajectory"></i> Explore More', 'creampoint' ),
			]
		);
...
// After the CreamPoint_Flip_Box class is defined, I must register the new widget class with Elementor:
Plugin::instance()->widgets_manager->register( new CreamPoint_Flip_Box() );