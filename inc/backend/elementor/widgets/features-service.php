 ...
 * Widget Name: Button
 */
class CreamPoint_Features_Service extends Widget_Base{
	...
	public function get_title() {
		return __( 'XP Features Service', 'creampoint' );
	}
	...
	protected function register_controls() {
        ...
        $repeater->add_control(
			...
			[
				...
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Service Title', 'creampoint' ),
				'placeholder' => __( 'Service Title', 'creampoint' ),
				'label_block' => true,
			]
		);
		$repeater->add_control(
			...
			[
				...
				'default' => esc_html__( 'Accelerate your innovation and transformation with a fully integrated suite of capabilities that puts digital at the heart of everything you do.', 'creampoint' ),
			]
		);
		$repeater->add_control(
			'link',
		...
		$this->add_control(
			'fservice_lists',
			[
				'label' => __( 'Features Service List Items', 'creampoint' ),
				'type' => Controls_Manager::REPEATER,
				'fields' => $repeater->get_controls(),
				'default' => [
					[
						'fservice_number' => __( '01', 'creampoint' ),
						'fservice_title' => __( 'Title #1', 'creampoint' ),
						'fservice_content' => __( 'Accelerate your innovation and transformation with a fully integrated suite of capabilities that puts digital at the heart of everything you do.', 'creampoint' ),
						'link' => '#',
					],
					[
						'fservice_number' => __( '02', 'creampoint' ),
						'fservice_title' => __( 'Title #2', 'creampoint' ),
						'fservice_content' => __( 'Accelerate your innovation and transformation with a fully integrated suite of capabilities that puts digital at the heart of everything you do.', 'creampoint' ),
						'link' => '#',
					],
				],
		...
		$this->add_control(
			'btn_text',
			[
				'label' => __( 'Label Button', 'creampoint' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Read More', 'creampoint' ),
			]
		);
...
// After the CreamPoint_Features_Service class is defined, I must register the new widget class with Elementor:
Plugin::instance()->widgets_manager->register( new CreamPoint_Features_Service() );