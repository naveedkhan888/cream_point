 ...
 * Widget Name: Tabs
 */
class CreamPoint_Tabs extends Widget_Base{
	...
	protected function register_controls() {
		...
		$repeater->add_control(
			'tab_title',
			[
				'label' => __( 'Title & Description', 'creampoint' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Tab Title', 'creampoint' ),
				'placeholder' => __( 'Tab Title', 'creampoint' ),
				'label_block' => true,
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'default' => __( 'Tab Content', 'creampoint' ),
				'placeholder' => __( 'Tab Content', 'creampoint' ),
		...
		$this->add_control(
			'xp_tabs',
			[
				'label' => __( 'Tabs Items', 'creampoint' ),
				'type' => Controls_Manager::REPEATER,
				'fields' => $repeater->get_controls(),
				'default' => [
					[
						'tab_title' => __( 'Tab #1', 'creampoint' ),
						'tab_content' => __( 'We help ambitious businesses like yours generate more profits by building awareness, driving web traffic, connecting with customers, and growing overall sales. Give us a call.', 'creampoint' ),
					],
					[
						'tab_title' => __( 'Tab #2', 'creampoint' ),
						'tab_content' => __( 'We help ambitious businesses like yours generate more profits by building awareness, driving web traffic, connecting with customers, and growing overall sales. Give us a call.', 'creampoint' ),
					],
				],
...
// After the CreamPoint_Tabs class is defined, I must register the new widget class with Elementor:
Plugin::instance()->widgets_manager->register( new CreamPoint_Tabs() );