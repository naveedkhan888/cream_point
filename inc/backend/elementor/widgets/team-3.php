 ...
 * Widget Name: Team 3
 */
class CreamPoint_Team3 extends Widget_Base{
	...
	public function get_title() {
		return __( 'XP Team 3', 'creampoint' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'color_icon_overlay',
			[
				'label' => __( 'Color Icon', 'creampoint' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
...
// After the CreamPoint_Team3 class is defined, I must register the new widget class with Elementor:
Plugin::instance()->widgets_manager->register( new CreamPoint_Team3() );