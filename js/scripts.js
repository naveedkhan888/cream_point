( function( $ ) {
    ...
    * --------------------------------------------------*/
	...
	$('#btn-loadmore').on('click',function(){
		...
		$.ajax({
			url : creampoint_loadmore_params.ajaxurl, // AJAX handler
			data : {
				'action': 'loadmore', // the parameter for admin-ajax.php
				'ppp'	: more,
				'cat'	: cat,
				'offset': offset,
				'nonce' : creampoint_loadmore_params.nonce // Pass nonce here
			},
			type : 'POST',
	...
	* --------------------------------------------------*/
	...
	$('.creampoint_block_hidden').hide();
	swt.on( 'change', function() {
		var parent = $(this).parents('.e-parent');
		if(this.checked) {
			parent.find('.r-switch').addClass('active');
			parent.find('.l-switch').removeClass('active');
			parent.find('.creampoint_block_show').hide();
			parent.find('.creampoint_block_hidden').show();
		}else{
			parent.find('.l-switch').addClass('active');
			parent.find('.r-switch').removeClass('active');
			parent.find('.creampoint_block_hidden').hide();
			parent.find('.creampoint_block_show').show();
		}
	});
